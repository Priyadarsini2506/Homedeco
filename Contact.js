...
const Chatbox = () => {
  ...
  const handleSubmit = (event) => {
    ...
    if (input.trim()) {
      ...
      setMessages([...messages, { type: 'user', text: input }, { type: 'ai', text: aiResponse }]);
      setInput('');
    }
  };
  ...
  const getAIResponse = (message) => {
    ...
    if (message.toLowerCase().includes('help')) return 'I am here to assist you. What do you need help with?';
      ...
      <div className="content">
        ...
        <section className="addresses">
          ...
          <div className="address-list">
            ...
            <p><strong>Branch 2:</strong> 25/6,Chruch street ,Bangalore</p>
          </div>
        </section>
